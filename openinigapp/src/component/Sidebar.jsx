...
export const Sidebar = () => {
  return (
    <div className="flex flex-col w-56 bg-white overflow-hidden  h-screen">
      <div className="flex items-center justify-center h-20">
        <img src={companylogo} alt="company-logo" className="w-28 h-10 absolute top-8 left-10" />
      </div>
        ...
        <li className="flex flex-col p-3">
          <a href="#" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
            ...
            <span className="text-lg font-medium flex items-center">
              <img src={Category} alt="category" className="w-8 h-8 absolute top-2.5 left-2" />
              Dashboard
            </span>
          </a>
        </li>
